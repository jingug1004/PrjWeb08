    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="filter-results">
                ...
                <c:forEach items="${userInfoList}" var="boardVO" varStatus="itr">

                    <div class="list-product-description product-description-brd margin-bottom-30">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.html"><img class="img-responsive sm-margin-bottom-20"
                                                                  src="/assets/img/blog/16.jpg" alt=""></a>
                            </div>
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
                                        ...
                                        <li><span class="gender text-uppercase">${boardVO.writer}</span></li>
                                        <li class="pull-right">
                                    ...
                                    <p class="margin-bottom-20">${boardVO.title}</p>
                                    ...
                                    <button type="button" class="btn-u btn-u-sea-shop">a2Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <%--<div class="list-product-description product-description-brd margin-bottom-30">--%>
                    <%--<div class="row">--%>
                        ...
                        <%--<div class="col-sm-8 product-description">--%>
                            <%--<div class="overflow-h margin-bottom-5">--%>
                                <%--<ul class="list-inline overflow-h">--%>
                                    <%--<li><h4 class="title-price"><a href="shop-ui-inner.html">b1Double-breasted</a>--%>
                                    <%--</h4></li>--%>
                                ...
                                <%--<div class="margin-bottom-10">--%>
                                    ...
                                    <%--<span class="title-price line-through">$95.00</span>--%>
                                <%--</div>--%>
                                <%--<p class="margin-bottom-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit.--%>
                                    <%--Maecenas sollicitudin erat nec ornarevolu tpat. Etiam ut felis nec nisl eleifend--%>
                                    <%--lobortis. Aenean nibh est, hendrerit non conva.</p>--%>
                                <%--<ul class="list-inline add-to-wishlist margin-bottom-20">--%>
                                    <%--<li class="wishlist-in">--%>
                                        <%--<i class="fa fa-heart"></i>--%>
                                        <%--<a href="#">Add to Wishlist</a>--%>
                ...
                <%--<div class="list-product-description product-description-brd margin-bottom-30">--%>
                    <%--<div class="row">--%>
                        <%--<div class="col-sm-4">--%>
                            <%--<a href="shop-ui-inner.html"><img class="img-responsive sm-margin-bottom-20"--%>
                                                              <%--src="/assets/img/blog/21.jpg" alt=""></a>--%>
                        <%--</div>--%>
                        <%--<div class="col-sm-8 product-description">--%>
                            <%--<div class="overflow-h margin-bottom-5">--%>
                                <%--<ul class="list-inline overflow-h">--%>
                ...
                <%--<div class="list-product-description product-description-brd margin-bottom-30">--%>
                    <%--<div class="row">--%>
                        <%--<div class="col-sm-4">--%>
                            <%--<a href="shop-ui-inner.html"><img class="img-responsive sm-margin-bottom-20"--%>
                                                              <%--src="/assets/img/blog/22.jpg" alt=""></a>--%>
                        <%--</div>--%>
                        <%--<div class="col-sm-8 product-description">--%>
                            <%--<div class="overflow-h margin-bottom-5">--%>
                                <%--<ul class="list-inline overflow-h">--%>
                ...
                <%--<div class="list-product-description product-description-brd">--%>
                    <%--<div class="row">--%>
                        <%--<div class="col-sm-4">--%>
                            <%--<a href="shop-ui-inner.html"><img class="img-responsive sm-margin-bottom-20"--%>
                                                              <%--src="/assets/img/blog/23.jpg" alt=""></a>--%>
                        <%--</div>--%>
                        <%--<div class="col-sm-8 product-description">--%>
                            <%--<div class="overflow-h margin-bottom-5">--%>
                                <%--<ul class="list-inline overflow-h">--%>

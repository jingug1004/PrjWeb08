...
<style type="text/css">
    .targetSpace {
        ...
        line-height: 1.2;
        height: 3.6em;
        /*http://webdir.tistory.com/483 [WEBDIR] 출처: http://webdir.tistory.com/483 [WEBDIR] */
    }
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.html">
                                    ...
                                    src="/assets/img/aUpload${boardVO.fullname}" alt=""></a>
                                <%-- /img/aUpload/ 2018 / 06 / 29 --%>
                            </div>
                    ...
                    <c:choose>
                        ...
                        <c:when test="${not empty pageMaker}">
                            <c:if test="${pageMaker.prev}">
                                <li><a href="userInfoList${pageMaker.makeQueryUserid(pageMaker.startPage - 1) }">&laquo;</a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="${pageMaker.startPage }"
                                ...
                                <li<c:out value="${pageMaker.cri.page == idx?' class=active':''}"/>>
                                    <a href="userInfoList${pageMaker.makeQueryUserid(idx)}">${idx}</a>
                                </li>
                            </c:forEach>

                            <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                <li><a href="userInfoList${pageMaker.makeQueryUserid(pageMaker.endPage + 1) }">&raquo;</a>
                                </li>
                            </c:if>
                        </c:when>
                    </c:choose>

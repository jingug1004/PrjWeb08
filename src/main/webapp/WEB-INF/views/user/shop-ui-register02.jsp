        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <form id="sky-form4" class="log-reg-block sky-form" role="form">
                    <%--<form id="sky-form4" class="log-reg-block sky-form" action="/user/registPost" method="post" role="form">--%>
                    ...
                    <div class="login-input reg-input">
                        <div class="row">
                            <div class="col-sm-6">
                                <section>
                                    <label class="input">
                                        <input id="uid" type="text" name="uid" placeholder="USER ID"
                                               class="form-control" title="ID" pattern="[a-zA-z].+[0-9]">
                            ...
                            <div class="col-sm-6">
                                <section>
                                    <label class="input">
                                        <input type="text" id="uname" name="uname" placeholder="존경하는 정치인 ex)문재인"
                    ...
                    <button id="idCreate" class="btn-u btn-u-sea-shop btn-block margin-bottom-20"
                            onclick="idCreateClick()">Create Account</button>

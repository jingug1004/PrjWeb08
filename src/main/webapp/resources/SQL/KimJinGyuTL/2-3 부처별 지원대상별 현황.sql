...
--SELECT * FROM T_STATS_STS WHERE STATS_FLAG = 'K0560203' and stats_yr = '2011';
--DELETE FROM T_STATS_STS WHERE STATS_FLAG = 'K0560203' and stats_yr = '2011';
...
(
     SELECT GROUPING_ID(D.GVM_INSTN_CD)   RN
       ...
       FROM (
            SELECT GVM_INSTN_CD
                 , DECODE( A.SURP_UNIT_TYP, 'K020001', COUNT(DISTINCT A.BIZ_CD))    BIZ_CNT1
                 , DECODE( A.SURP_UNIT_TYP, 'K020001', SUM(REAL_SURP_AMT))          BIZ_AMT1 
                 , DECODE( A.SURP_UNIT_TYP, 'K020002', COUNT(DISTINCT A.BIZ_CD))    BIZ_CNT2
                 , DECODE( A.SURP_UNIT_TYP, 'K020002', SUM(REAL_SURP_AMT))          BIZ_AMT2 
                 , DECODE( A.SURP_UNIT_TYP, 'K020003', COUNT(DISTINCT A.BIZ_CD))    BIZ_CNT3
                 , DECODE( A.SURP_UNIT_TYP, 'K020003', SUM(REAL_SURP_AMT))          BIZ_AMT3
              ...
              GROUP BY GVM_INSTN_CD, SURP_UNIT_TYP
            ) D

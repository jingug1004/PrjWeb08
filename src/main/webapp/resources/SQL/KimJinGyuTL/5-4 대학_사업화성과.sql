...
SELECT '2011'
     ...
     , TO_CHAR(DECODE(A.PER_AMT,0,0,ROUND(A.CNT1/B.PER_AMT,1)),'FM999,990.0') PER_AMT_IN_CNT1
     , TO_CHAR(DECODE(A.PER_AMT,0,0,ROUND(A.CNT2/B.PER_AMT,1)),'FM999,990.0') PER_AMT_IN_CNT2
     , TO_CHAR(DECODE(A.PER_AMT,0,0,ROUND(A.CNT3/B.PER_AMT,1)),'FM999,990.0') PER_AMT_IN_CNT3
     , A.ORDERED
     , 'SQL'

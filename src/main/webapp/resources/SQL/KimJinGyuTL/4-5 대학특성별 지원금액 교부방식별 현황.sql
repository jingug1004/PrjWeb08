/*****************************************************************************
* 3-5-1 대학 지원금액교부방식별 현황
******************************************************************************/

--SELECT *  FROM T_STATS_STS WHERE STATS_FLAG = 'UK0560306'  and stats_yr = '2011';
--DELETE  FROM T_STATS_STS WHERE STATS_FLAG = 'UK0560306'  and stats_yr = '2011';
...
INSERT INTO T_STATS_STS
    ...
    , ATTR11_VAL, ATTR12_VAL, ATTR13_VAL, ATTR14_VAL
    , ATTR43_VAL
    , RGSTR_ID, RGST_DTTM
    )   
WITH TMP_A AS 
...
/*****************************************************************************
* 3-5-2 전문대학 지원금액교부방식별 현황
******************************************************************************/

--SELECT *  FROM T_STATS_STS WHERE STATS_FLAG = 'CK0560306'  and stats_yr = '2011';
--DELETE  FROM T_STATS_STS WHERE STATS_FLAG = 'CK0560306'  and stats_yr = '2011';
